    ...
    return (<AuthLayout>
        <div>
            ...
            <div className='flex gap-4'>
                <button className="text-lg font-medium bg-light hover:bg-white text-text3 w-full mt-5 py-3 rounded-[10px] border border-light hover:border-border-color cursor-pointer">Cancel</button>

                <button className="text-white text-lg font-medium bg-primary hover:bg-white hover:text-primary w-full mt-5 py-3 rounded-[10px] border border-primary cursor-pointer capitalize">update email</button>
            </div>
