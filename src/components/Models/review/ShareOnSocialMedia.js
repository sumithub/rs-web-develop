            ...
            <div>
                ...
                <div className="mt-2.5 grid grid-cols-6 gap-[18px]">
                    <div className="text-center">
                        <img src="/images/fb.png" alt="fb" width={41} height={41} className="mx-auto" />
                        <h2 className="mt-[15px] text-sm font-medium">Facebook</h2>
                    </div>
                    <div className="text-center">
                        <img src="/images/twitter.png" alt="twitter" width={41} height={41} className="mx-auto" />
                        <h2 className="mt-[15px] text-sm font-medium">Twitter</h2>
                    </div>
                    <div className="text-center">
                        <img src="/images/in.png" alt="in" width={41} height={41} className="mx-auto" />
                        <h2 className="mt-[15px] text-sm font-medium">Linkedin</h2>
                    </div>
                    <div className="text-center">
                        <img src="/images/insta.png" alt="insta" width={41} height={41} className="mx-auto" />
                        <h2 className="mt-[15px] text-sm font-medium">Instagram</h2>
                    </div>
                    <div className="text-center">
                        <img src="/images/dribble.png" alt="dribble" width={41} height={41} className="mx-auto" />
                        <h2 className="mt-[15px] text-sm font-medium">Dribble</h2>
                    </div>
                    <div className="text-center">
                        <img src="/images/more.png" alt="more" width={41} height={41} className="mx-auto" />
