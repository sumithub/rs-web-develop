                    ...
                    <div>
                        ...
                        <div className="border border-border-color bg-[#0396FF1a] rounded-md mt-2">
                            ...
                            <div className="grid grid-cols-2 gap-2 p-2 ">
                                <InputForm label="Button Label" isRequired={true} placeholder=""
                        ...
                        <div className="border border-border-color bg-[#0396FF1a] rounded-md mt-2 ">
                            ...
                            <div className="p-2">
                                <SelectForm defaultOption="Popup Delay" label="popup Delay" isRequired={true}
                            ...
                            <div className="mb-2">
                                <div className="pl-2">Auto-Trigger Popup</div>
                            </div>
                        </div>
