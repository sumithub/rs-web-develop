...
export default function ProgressTopBar({ stepTitle1, stepTitle2, stepTitle3, stepTitle4, stepTitle5, totalSteps = 5 }) {
    const [step, setStep] = useState(1)

    return (<>
        <div className={`flex justify-center items-center md:mb-10 mb-6 ${step === totalSteps ? "completed" : ""}`}>
            <div className="flex items-center mb-7">
                <div className={`steps ${step >= 1 ? "active" : ""}`} role="button" onClick={() => {
                    ...
                    {step > 1 ? 1 : <span className="font-semibold">1</span>}
                    <span></span>
