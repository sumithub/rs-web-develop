        ...
        <div className={`mt-[15px] ${class_}`}>
            ...
            <div ref={ref} className="relative">
                <button type='button'
                    ...
                    disabled={disabled}
                    className={`${inputClass} cursor-pointer flex items-center gap-2 border ${error ? "border-danger" : "border-border-color"
                        } rounded-lg py-[7.7px] px-2 capitalize text-[13px] text-text3 w-full focus-visible:outline-none shrink-0 ${disabled ? "opacity-50 cursor-not-allowed" : ""
