...
export default function Rating(props) {
    ...
    return (
        <div className={`laptop:mb-2 mb-3 relative ${containerClass}`}>
            ...
            <div className={`capitalize font-normal w-full border hover:border-primary/60 rounded-lg text-sm py-3 px-2.5 flex gap-1 items-center ${error ? "border-danger" : "border-input-border"}`}>
